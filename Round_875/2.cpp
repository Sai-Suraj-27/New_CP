    ...
    while(t--)
    {
        ...
        for(i=1;i<n;i++)
        {
            ...
            else
            {
                ...
                {
                    mp[v[i-1]] = max(mp[v[i-1]],temp);
                }
                temp = 1;
            }
        }
        if(mp.find(v[n-1]) == mp.end())
        {
            mp[v[n-1]] = temp;
            temp = 1;
        }
        ...
        for(i=1;i<n;i++)
        {
            ...
            {
                if(mp1.find(v1[i-1]) == mp1.end())
                {
                    mp1[v1[i-1]] = temp;
                }
                else
                {
                    mp1[v1[i-1]] = max(mp1[v1[i-1]],temp);
                }
                temp = 1;
            }
        }
        if(mp1.find(v1[n-1]) == mp1.end())
        {
            mp1[v1[n-1]] = temp;
            temp = 1;
        }
        ...
        {
            mp1[v1[n-1]] = max(mp1[v1[n-1]],temp);
            temp=1;
        }
        ll ans = 1;
        for(i=0;i<n;i++)
        {
            //cout << mp[v[i]] << " " << mp1[v[i]] << endl;
